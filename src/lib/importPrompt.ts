...
- "nenngewicht" ist das Gewicht pro Gebinde in Gramm als ganze Zahl (z. B. 1000 für 1 kg).
- "preis" ist der Preis pro Gebinde in ${currency} als Zahl mit Punkt als Dezimaltrennzeichen (z. B. 29.99), ohne Währungszeichen. Preise in einer anderen Währung nicht umrechnen, sondern das Feld weglassen.
